...
@Service
public class XMLAdESSHA384 {

	public ServiceResponse<String> signAdESSHA384(SignXmlReq req) throws Exception {
		...
		String outputFilePath = "./data/signing/test_output_AdES_sha384.xml";
