...
@Service
public class XMLAdESSHA256 {

	public ServiceResponse<String> signAdESSHA256(SignXmlReq req) throws Exception {
		...
		String outputFilePath = "./data/signing/test_output_AdES_sha256.xml";
//		String url = "http://10.0.21.99:8777/";
//		String profleId = "adss:signing:profile:011";
...
//			System.out.println(obj_signingResponse.getDocument());
//			byte[] bytes=obj_signingResponse.getDocument();
...
//                response.setCode(0;)
			...
			if (obj_signingResponse.getResultMinor() != null && !obj_signingResponse.getResultMinor().equals("")) {
				System.out.println("Result Minor : " + obj_signingResponse.getResultMinor());
				return new ServiceResponse<String>(MessageCode.FAILED, obj_signingResponse.getResultMinor(), null);
			}
