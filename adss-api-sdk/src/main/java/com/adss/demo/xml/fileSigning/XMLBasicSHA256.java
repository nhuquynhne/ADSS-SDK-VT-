...
@Service
public class XMLBasicSHA256 {

	public static ServiceResponse<String> signBasicSHA256(SignXmlReq req) throws Exception {
		...
		String outputFilePath = "./data/signing/test_output_basic_sha256.xml";
