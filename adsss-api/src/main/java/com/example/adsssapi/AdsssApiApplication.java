...
public class AdsssApiApplication {

    private static String m_adssURL = "https://10.0.21.99:8774";
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(AdsssApiApplication.class, args);
...
//        }
    ...
    /**
     * It creates RegistrationRequest for ADSS-RA-Service with type
     * RegistrationRequest.REQUEST_TYPE_CREATE_CERTIFICATE
     *
    ...
    public static boolean createCertificate() {
        try {
            ...
            createSigningCertRequest.setRequestId("request-002"); //Business applicatoin request ID
